...
struct DataEvtSummary_t {
    ...
    //muon
    Int_t mn;
    Float_t mn_px[MAXPARTICLES],mn_py[MAXPARTICLES],mn_pz[MAXPARTICLES],mn_en[MAXPARTICLES],mn_tkLayers[MAXPARTICLES];
    ...
    Bool_t en_passVeto[MAXPARTICLES],en_passLoose[MAXPARTICLES],en_passMedium[MAXPARTICLES],en_passTight[MAXPARTICLES],en_passHEEP[MAXPARTICLES],en_passMedium_noIso[MAXPARTICLES];
